...
public enum Message
{
	...
	WARDEN_VIP_DONATED("name", "amount"),
	WARDEN_VIP_EXPIRATION("time"),
	WARDEN_VIP_EXPIRATION_OTHER("name", "time"),
	WARDEN_VIP_EXPIRED(),
	WARDEN_VIP_EXPIRED_OTHER("name"),
	WARDEN_VIP_INVALID_AMOUNT(),
	WARDEN_VIP_INVALID_NAME("name"),
	WARDEN_VIP_NEW_RANK("name", "amount", "rank"),
	WARDEN_VIP_NO_RECORD("name"),
	WARDEN_VIP_PENDING("name"),
	WARDEN_VIP_WITH_EXPIRE("days");
